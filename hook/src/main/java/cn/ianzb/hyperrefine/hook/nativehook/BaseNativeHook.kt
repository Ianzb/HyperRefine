package cn.ianzb.hyperrefine.hook.nativehook
...
/**
 * 单条原生 hook 规则基类，与 [cn.ianzb.hyperrefine.hook.base.BaseHook] 对称。
 *
...
abstract class BaseNativeHook {
    ...
    /** 加载原生库；由 [cn.ianzb.hyperrefine.hook.base.BaseLoad] 调用。 */
